...
std::shared_ptr<cs6300::BasicBlock> cs6300::MemoryAccessExpression::emit() const
{
  ...
  result->instructions.emplace_back(ThreeAddressInstruction::LoadMemoryOffset, getLabel(),  m_value, m_offset);
  return result;
}
...
int cs6300::MemoryAccessExpression::offset() const { return m_offset; }

int cs6300::MemoryAccessExpression::value() const { return m_value; }

bool cs6300::MemoryAccessExpression::isConst() const { return false; }
