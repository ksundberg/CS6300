...
namespace cs6300
{
enum MemoryLocation { GLOBAL = 28, STACK = 29, DYNAMIC = 30  }; //TODO These memory location labels should be moved to Backend Mips generation
...
{
public:
  SymbolTable(std::shared_ptr<SymbolTable> parent, cs6300::MemoryLocation memory_location)
  ...
  cs6300::MemoryLocation getMemoryLocation()
  {
