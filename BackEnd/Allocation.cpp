...
std::set<std::shared_ptr<cs6300::BasicBlock>> allBlocks(std::pair<std::shared_ptr<cs6300::BasicBlock>, std::shared_ptr<cs6300::BasicBlock>>b)
{
...
void cs6300::locRegAlloc(std::pair<std::shared_ptr<cs6300::BasicBlock>, std::shared_ptr<cs6300::BasicBlock>>b)
{
    int count = 0;
...
std::vector<std::set<int>> cs6300::regDeps(std::shared_ptr<cs6300::BasicBlock>b)
{
...
bool cs6300::pushUp(std::shared_ptr<cs6300::BasicBlock>parent, std::shared_ptr<cs6300::BasicBlock>child)
{
