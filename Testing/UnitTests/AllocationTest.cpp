...
using cs6300::ThreeAddressInstruction;

#define TAL ThreeAddressInstruction
...
TEST_CASE("AllocationTest", "regalloc")
{
    ...
    b0->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::LoadValue,1,0,0));

    b1->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::LoadValue, 2, 1, 0));
    b1->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::LoadValue, 3, 100, 0));
    b1->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::IsLess, 4, 2, 3));

    b2->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::LoadValue, 5, 5, 0));
    b2->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::Modulo, 7, 2, 5));
    b2->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::StoreMemory, 7, 2, 0));

    b3->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::WriteStr, 7, 0, 0));

    b4->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::WriteStr, 7, 0, 0));

    b5->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::LoadValue, 9, 1, 0));
    b5->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::LoadValue, 10, 1, 0));
    b5->instructions.push_back(ThreeAddressInstruction(ThreeAddressInstruction::Add, 11, 9, 10));
