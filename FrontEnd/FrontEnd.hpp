...
int AppendArgs(int, int);
int AppendElseList(int list,int expr,int statement); 
int ArrayType(int lower,int upper,int type);
...
void AddProcedure(int signature);
void AddProcedure(int signature,int body);
